        ...
        public override void Install(CommandsManager manager)
        {
            manager.AddCommand(new CommandStub("eval", "Evaluates real-time C# code. Be careful with this",
                "Evaluates C# code that is dynamically compiled.\n\nThe following namespaces are available for use:\n * DiscordDotNet\n * System.Threading\n * DiscordDotNet.Objects\n\n\nMake sure your function returns a string value.\nYou can reference the DiscordDotNet client by using `discordClient`.", PermissionType.User, 1, e =>
                {
                    ...
                    try
                    {
                        var eval = EvalProvider.CreateEvalMethod<DiscordClient, string>(whatToEval, EvalNamespaces, new string[] { "DiscordDotNet.dll", "System.Data.Linq.dll" });
                        string res = "";
                        Thread.Sleep(1000);
