...
namespace DiscordSharp
{
    ...
    public class DiscordProperties
    {
        ...
        /// <summary>
        /// Whatever device you want to be on. (Default: DiscordDotNet Bot)
        /// </summary>
        [JsonProperty("$device")]
        public string Device
        { get; set; } = "DiscordDotNet Bot";
    ...
    public class DiscordClient
    {
        ...
        static string UserAgentString = $" (http://github.com/Luigifan/DiscordDotNet, {typeof(DiscordClient).Assembly.GetName().Version.ToString()})";
        ...
        */
        ...
        /// </summary>
        /// <param name="useDotNetWebsocket">If true, DiscordDotNet will connect using the .Net Framework's built-in WebSocketClasses.
